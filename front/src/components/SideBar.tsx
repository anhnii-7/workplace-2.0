...
const SideBar = () => {
    ...
    return (
        ...
        >
            <div className='flex items-center gap-3 p-2 rounded-md shadow-[0px_0px_4px_2px_rgba(125,168,225,0.12)]'>
                <Image
            ...
            <div className='flex flex-col gap-2'>
                {
                    items.map((i) => {
                        ...
                        return (
                            <Link href={i.url} className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors duration-150 ${isActive
