...
interface HobbyUserCardProps {
  user: HobbyUser;
  onSendRequest: (userId: string) => void;
  isLoading?: boolean;
}

export function HobbyUserCard({ user, onSendRequest, isLoading = false }: HobbyUserCardProps) {
  return (
      ...
      <CardContent className="p-4">
        <div className="flex flex-col items-center">
          ...
          <Button
            ...
            disabled={isLoading || !user.availableSchedules?.length}
