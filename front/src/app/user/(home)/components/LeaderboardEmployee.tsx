...
function LeaderboardEmployee({ user }: LeaderboardEmployeeProps) {
    return (
        <div>
            <div className='h-[66px] flex justify-between items-center bg-amber-50 rounded-xl gap-10 px-2 py-1'>
                <div className="flex flex-col gap-1">
                    <div className='flex gap-4 items-center'>
                        <p className='w-6 h-6 bg-amber-200 rounded-full flex items-center justify-center text-base font-medium leading-6'>
                            {user.rank}
                        </p>
